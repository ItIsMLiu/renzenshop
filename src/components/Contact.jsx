...
function Contact() {
  return <>
    <Container fluid className="genericHero contactImg d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <p className="fs-4">We'd love to hear from you! Whether you have a question, feedback, or need assistance, feel free to reach out to us.</p>
    </Container>
        ...
        <Col lg={6} md={8} sm={11}>
          ...
          <Card className="py-4">
            ...
            <ul className="nav nav-fill nav-underline">
              ...
              <li className="nav-item icon-link">
                <a className="nav-link" href="https://www.google.com/maps/place/Bristol/@51.4683734,-2.7555235,11z/data=!3m1!4b1!4m6!3m5!1s0x4871836681b3d861:0x8ee4b22e4b9ad71f!8m2!3d51.454513!4d-2.58791!16zL20vMDk1bDA?entry=ttu" target="_blank">
          ...
          <Card className="py-4">
            ...
            <ul className="nav nav-fill nav-underline">
              <li className="nav-item icon-link">
                <a className="nav-link" href="https://www.instagram.com/renzenshop/" target="_blank">
              ...
              <li className="nav-item icon-link">
                <a className="nav-link" href="https://www.facebook.com/people/RenZen-Shop/61550549634449/" target="_blank">
