...
function About() {
  return <>
    <div className="mb-4">
      <div className="container-fluid aboutHero d-flex flex-column justify-content-center align-items-center">
        <h1 className="col-12 fw-bold text-center">About Us</h1>
        <p className="col-12 fs-4 text-center">
          Just a little bit about our background.
        </p>
      </div>
    </div>

    <div className="container-fluid d-flex flex-column justify-content-center align-items-center aboutBody" id="about">
        <div className="container-fluid col-lg-10 col-md-12 col-sm-12 section-block">
          <div className="row">
            <div className="card col-lg-12 col-md-12 col-sm-12 d-flex flex-column justify-content-center align-items-center text-center">
            ...
            <div className="card col-lg-12 col-md-12 col-sm-12 d-flex flex-column justify-content-center align-items-center text-center">
              <h2 className="card-title">Speak with us about your needs!</h2>
              ...
              >
                <button className="btn btn-primary" type="button">Contact Now!</button>
              </NavLink>
            </div>
